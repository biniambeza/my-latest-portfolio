    ...
    >
      <div className="max-w-5xl w-full mx-auto">
        ...
        <div className="relative ml-2 md:ml-0">
          <div className="absolute left-0 md:left-34 top-2 bottom-2 w-px bg-black/15 dark:bg-[#303238]" />
            ...
            {experience.map((item, index) => (
              <article key={item.period} className="relative grid md:grid-cols-[8.5rem_1fr] gap-6 md:gap-10">
                ...
                <div className="relative pl-8 md:pl-10">
                  <span className="absolute -left-1.25 md:-left-1.25 top-5 w-2.5 h-2.5 rounded-full bg-[#1597ff] ring-4 ring-[#e5e7eb] dark:ring-[#050505]" />
